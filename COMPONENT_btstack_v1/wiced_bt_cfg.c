...
//uint8_t BT_LOCAL_NAME[] = { 'b','l', 'e', '_', 'h', 'i', 'd','\0' };
uint8_t BT_LOCAL_NAME[] = { 'B','T', '_', 'S', 'P', 'P', '\0' };
...
const wiced_bt_cfg_buf_pool_t hci_ble_hid_cfg_buf_pools[WICED_BT_CFG_NUM_BUF_POOLS] =
{
/*  { buf_size, buf_count, }, */
...
//
//#ifndef DEV_NAME
//#define DEV_NAME "LE HID Keyboard"
//#endif
//
///*****************************************************************************
// * wiced_bt core stack configuration
